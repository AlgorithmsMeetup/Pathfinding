...
var START_X = 0;
var START_Y = 0;
var GOAL_X = MAP_WIDTH - 1;
var GOAL_Y = MAP_HEIGHT - 1;
...
function draw(goalNode) {
    drawStartGoal(goalNode.x, goalNode.y, GOAL_COLOR);
    drawStartGoal(start.x, start.y, START_COLOR);
...
function drawStartGoal(x, y, color) {
    drawNode(x, y, color);
}
